...
MovieScreening MeanGrillsScreening1 = new MovieScreening(new DateTime(2024, 02, 02, 20, 00, 00), 8.5);
...
MovieScreening MeanGrillsScreening2 = new MovieScreening(new DateTime(2024, 02, 01, 20, 00, 00), 8.5);
